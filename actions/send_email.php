...
class SendEmail{
    ...
    function SendEmailFromTemplate(){
        $txt = $this->getPasswordResetTemplate($this->firstname);
    ...
    <head>
        ...
        <title>Gobinit is your one stop app for creating, planning, and carrying out all of your bucketlist dreams.</title>
        <style type="text/css">
            /* RESET STYLES */
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" class="textContent">
                                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                    Reset your Gobinit Bucketlist password
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                        ...
                                                        <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent">
                                                                    <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Gobinit Bucketlists</h1>
                                                                    ...
                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Sorry about the login troubles ' . $firstname . '! Click the button below to reset your password. If you continue to experience login issues, please contact us at support@gobinit.com.</div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- // CONTENT TABLE -->
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            <td valign="top" class="textContent">
                                                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Plan your dreams. Live your dreams.</div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <!-- // CONTENT TABLE -->
                                                        ...
                                                        <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td valign="top" bgcolor="#E1E1E1">
                                                                    ...
                                                                    <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                        <div>Copyright &#169; 2020 <a href="https://www.gobinit.com" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Gobinit</span></a>. All&nbsp;rights&nbsp;reserved.</div>
